  ...
  return (
    <div>
      ...
      >
        ...
        <h2 className="text-lg font-semibold">{props.fare.car} Rs.</h2>
      </div>
      <div
        onClick={() => {
          props.setConfirmRidePanel(true);
      ...
      >
        ...
        <h2 className="text-lg font-semibold"> {props.fare.moto} Rs.</h2>
      </div>
      <div
        onClick={() => {
          props.setConfirmRidePanel(true);
      ...
      >
        ...
        <h2 className="text-lg font-semibold">{props.fare.auto} Rs.</h2>
      </div>
    </div>
  );
};
